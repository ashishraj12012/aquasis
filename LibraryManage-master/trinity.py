...
class menu:
    ...
    def __init__(self):
       ...
       # self.root.state('zoomed')
        ...
        l1=Button(self.a,text='Add Record',font='Papyrus 22 bold',fg='black',bg='yellow',width=19,padx=10,borderwidth=0,command=self.book).place(x=100,y=500)
        l2=Button(self.a,text='View Record',font='Papyrus 22 bold',fg='black',bg='yellow',width=19,padx=10,borderwidth=0,command=self.student).place(x=800,y=500)
        self.root.mainloop()
    ...
    def book(self):
        ...
        l1=Button(self.a,text='Add Record',font='Papyrus 22 bold',fg='black',bg='yellow',width=15,padx=10,command=self.addbook).place(x=12,y=100)
        l2=Button(self.a,text='Search Record',font='Papyrus 22 bold',fg='black',bg='yellow',width=15,padx=10,command=self.search).place(x=12,y=200)

        l4=Button(self.a,text='All Record',font='Papyrus 22 bold',fg='black',bg='yellow',width=15,padx=10,command=self.all).place(x=12,y=300)
    ...
    def addbook(self):
        ...
        l1=Label(self.f1,text='Unique ID : ',font='Papyrus 12 bold',fg='Orange',bg='Black',pady=1).place(x=50,y=50)
        ...
        l3=Label(self.f1,text='Auth. Name:',font='Papyrus 12 bold',fg='orange',bg='Black',pady=1).place(x=50,y=150)
        e3=Entry(self.f1,width=45,bg='orange',fg='black',textvariable=self.aauthor).place(x=150,y=150)
        l4=Label(self.f1,text='Pub. Name : ',font='Papyrus 12 bold',fg='orange',bg='Black',pady=1).place(x=50,y=200)
    ...
    def adddata(self):
        ...
        try:
            if (a and b and c and d  )=="":
                ...
                values (?,?,?,?,?,?)",(a.capitalize(),b.capitalize(),c.capitalize(),d.capitalize(),e.capitalize()));
                conn.commit()
    ...
    def search(self):
        ...
        self.f1=Frame(self.a,height=500,width=650,bg='black')
        self.f1.place(x=500,y=100)
        l1=Label(self.f1,text='Unique ID/Title/Auth. Name: ',font=('Papyrus 10 bold'),bd=2, fg='orange',bg='black').place(x=20,y=40)
    ...
    def serch1(self):
        k=self.sid.get()
        if k!="":
            self.list4=("Unique ID","TITLE","AUth. Name","Pub. Name")
    ...
    def all(self):
        ...
        conn=sqlite3.connect('test3.db')
        self.list3=("Unique ID","TITLE","Auth. Name","Pub. Name")
...
def Database():
    ...
    cursor.execute("SELECT * FROM `login` WHERE `username` = 'Ashish' AND `password` = 'Raj'")
    if cursor.fetchone() is None:
        cursor.execute("INSERT INTO `login` (username, password) VALUES('Ashish', 'root')")
        conn.commit()
